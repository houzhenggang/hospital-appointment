...
public class DefaultQCloudClient implements QCloudClient {
	 ...
	 * 获取签名信息
	 */
	public Map<String,String> getUserSigInfo(String identifier) throws QCloudException {
		try {
			Map<String,String> result = Maps.newHashMap();
			result.put("identifier", identifier);
			result.put("userSig", sigCache.get(identifier));
			result.put("appId", imConfig.getSdkAppId());
			return result;
